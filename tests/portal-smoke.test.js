...
assert(/admin-dashboard\.js\?v=46/.test(adminDashboardHtml), 'admin dashboard should request the current Coach Tools dashboard script');
...
assert(/styles\.css\?v=68/.test(leaderboardHtml), 'leaderboard page should request the current stylesheet version');
assert(/styles\.css\?v=68/.test(interschoolTeamHtml), 'interschool team page should request the current stylesheet');
