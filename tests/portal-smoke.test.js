...
assert(/gwynne-park-run-club-v187/.test(serviceWorker), 'service worker cache should be bumped after today\'s deploy so returning browsers pick up the new build instead of serving stale cache-first assets');
...
assert(/admin-dashboard\.js\?v=107/.test(adminDashboardHtml), 'admin dashboard should request the current live beta dashboard script');
...
assert(/gwynne-park-run-club-v187/.test(serviceWorker), 'service worker cache should be bumped for the About page refresh');
