...
assert(/admin-dashboard\.js\?v=42/.test(adminDashboardHtml), 'admin dashboard should request the current Coach Tools dashboard script');
...
assert(/gwynne-park-run-club-v96/.test(serviceWorker), 'service worker cache should be bumped for support link update');
