...
assert(/styles\.css\?v=53/.test(leaderboardHtml), 'leaderboard page should request the privacy pledge stylesheet version');
assert(/styles\.css\?v=53/.test(interschoolTeamHtml), 'interschool team page should request the current stylesheet');
...
assert(/donate-coffee-btn/.test(adminDashboardHtml), 'admin dashboard footer should include a low-key donate a coffee button');
assert(/mailto:support@gwynneparkrunclub\.com\.au\?subject=Donate%20a%20coffee/.test(adminDashboardHtml), 'donate button should use a privacy-safe mailto placeholder');
assert(/feature-suggestion-btn/.test(styles), 'site footer should style the feature suggestion button');
assert(/donate-coffee-btn/.test(styles), 'site footer should style the donate a coffee button');
...
assert(/gwynne-park-run-club-v79/.test(serviceWorker), 'service worker cache should be bumped for Interschool Athletics tidy-up');
