...
assert(/admin-dashboard\.js\?v=45/.test(adminDashboardHtml), 'admin dashboard should request the current Coach Tools dashboard script');
...
assert(/Saved athletics consent list/.test(adminDashboardJs), 'admin team overview should show saved consent checklist students');
assert(/Put through/.test(adminDashboardJs) && /Not yet/.test(adminDashboardJs), 'admin team overview should show each saved student consent status');
...
assert(/athletics-consent-status-toggle/.test(styles), 'styles should support inline consent-received toggles in the modal checklist');
assert(/athletics-consent-saved-list/.test(styles), 'styles should support the saved consent list inside team overview');
assert(/styles\.css\?v=67/.test(leaderboardHtml), 'leaderboard page should request the current stylesheet version');
assert(/styles\.css\?v=67/.test(interschoolTeamHtml), 'interschool team page should request the current stylesheet');
...
assert(/gwynne-park-run-club-v99/.test(serviceWorker), 'service worker cache should be bumped for support link update');
